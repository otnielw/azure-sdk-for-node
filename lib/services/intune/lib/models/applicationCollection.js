...
/**
 * Deserialize the instance to ApplicationCollection schema
 *
 * @param {JSON} instance
 *
 */
ApplicationCollection.prototype.deserialize = function (instance) {
  if (instance) {
    if (instance['value']) {
      var deserializedInstancevalue = [];
        instance['value'].forEach(function(element) {
        if (element) {
          element = new models['Application']().deserialize(element);
        }
