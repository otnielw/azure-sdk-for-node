...
/**
 * Deserialize the instance to GroupsCollection schema
 *
 * @param {JSON} instance
 *
 */
GroupsCollection.prototype.deserialize = function (instance) {
  if (instance) {
    if (instance['value']) {
      var deserializedInstancevalue = [];
        instance['value'].forEach(function(element) {
        if (element) {
          element = new models['GroupItem']().deserialize(element);
        }
