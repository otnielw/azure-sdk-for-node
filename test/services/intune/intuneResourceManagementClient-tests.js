...
//var guidPrefix = 'dac05ad6-1d42-4e31-a116-0a5fdcc0';
/*var requiredEnvironment = [{
  name: 'USERNAME',
  defaultValue: 'admin@franktrtestdomain.onmicrosoft.com'
}, {
  name: 'PASSWORD',
  defaultValue: 'P0rsche911'
}, {
  name:
}];*/
...
describe('Intune Resource Management', function() {
  ...
  afterEach(function(done) {
    suite.baseTeardownTest(deleteCreatedPolicies);
  ...
  describe('- Policies', function() {
    describe('- iOS', function() {
      ...
      it('- createOrUpdateMAMPolicy', function(done) {
        ...
        var policyId = uuid.v4(); //suite.generateId(guidPrefix, generatedGuids);
...
function createInitialPolicies(done) {
  ...
  iOSPolicyId = uuid.v4(); //suite.generateId(guidPrefix, generatedGuids);
  ...
  androidPolicyId = uuid.v4(); //suite.generateId(guidPrefix, generatedGuids);
